...
describe('Exponentiation', function () {
    ...
    it('raises a positive integer to zero power', function (done) {
        request.get('/arithmetic?operation=exponentiate&operand1=42&operand2=0')
            .expect(200)
            .end(function (err, res) {
    ...
    it('raises a positive integer to a negative power', function (done) {
        request.get('/arithmetic?operation=exponentiate&operand1=2&operand2=-2')
            .expect(200)
            .end(function (err, res) {
    ...
    it('raises a floating point number to a power', function (done) {
        request.get('/arithmetic?operation=exponentiate&operand1=2.5&operand2=2')
            .expect(200)
            .end(function (err, res) {
    ...
    it('raises with exponential notation', function (done) {
        request.get('/arithmetic?operation=exponentiate&operand1=1e1&operand2=2')
            .expect(200)
            .end(function (err, res) {
